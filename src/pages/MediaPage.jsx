...
export function MediaPage() {
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h1 className="text-xl font-semibold text-slate-900 dark:text-slate-100">Media</h1>
      ...
      <Card className="flex flex-col items-center justify-center py-16 text-center">
        ...
        <h2 className="mt-3 text-sm font-semibold text-slate-700 dark:text-slate-300">Fitur Media Segera Hadir</h2>
        <p className="mt-1 max-w-xs text-xs text-slate-400">
          Upload, kelola, dan publikasi konten media dari satu tempat. Sedang dalam pengembangan.
        </p>
      </Card>
    </div>
  );
