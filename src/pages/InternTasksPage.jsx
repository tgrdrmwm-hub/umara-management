      ...
      {showForm && (
        <Card className="p-5">
          ...
          >
            ...
            <div className="space-y-1 sm:col-span-2">
              <label className="text-xs font-medium text-slate-600 dark:text-slate-400">
                Letak File / Dokumen (Opsional)
              </label>
              <Input
                placeholder="Link Google Drive / Folder lokal..."
                    ...
                    <div className="mt-3 flex flex-wrap gap-1.5 border-t border-slate-100 pt-2.5 dark:border-white/8">
                      ...
                      {!isMagang && (
                        <Button
                          ...
                          onClick={() =>
                            void deleteInternTask(task.id).then(() =>
                              refresh("Tugas dihapus"),
                            )
                          }
                        >
                          Hapus
