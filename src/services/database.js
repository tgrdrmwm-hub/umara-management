...
export async function createClient(values) {
  ...
  const { error } = await supabase.from("clients").insert({
    ...
    keterangan_aktivasi: values.keterangan_aktivasi,
    keterangan_konfirmasi: values.keterangan_konfirmasi,
    password_djp: values.password_djp,
    nik_op: values.nik_op,
    password_coretax: values.password_coretax,
    passphrase: values.passphrase,
    kode_aktivasi: values.kode_aktivasi,
    efin: values.efin,
    alamat: values.alamat,
    password_email: values.password_email,
    no_telepon: values.no_telepon,
    nik_pj: values.nik_pj,
    npwp_pj: values.npwp_pj,
    alamat_pj: values.alamat_pj,
    konfirmasi: values.konfirmasi,
...
function toClient(row) {
  return {
    ...
    keterangan_aktivasi: String(row.keterangan_aktivasi ?? ""),
    keterangan_konfirmasi: String(row.keterangan_konfirmasi ?? ""),
    password_djp: String(row.password_djp ?? ""),
    nik_op: String(row.nik_op ?? ""),
    password_coretax: String(row.password_coretax ?? ""),
    passphrase: String(row.passphrase ?? ""),
    kode_aktivasi: String(row.kode_aktivasi ?? ""),
    efin: String(row.efin ?? ""),
    alamat: String(row.alamat ?? ""),
    password_email: String(row.password_email ?? ""),
    no_telepon: String(row.no_telepon ?? ""),
    nik_pj: String(row.nik_pj ?? ""),
    npwp_pj: String(row.npwp_pj ?? ""),
    alamat_pj: String(row.alamat_pj ?? ""),
    konfirmasi: String(row.konfirmasi ?? ""),
